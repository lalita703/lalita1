...
public class TravelPartnerBajaj {
...
//	TpQuotes tpquotes = new TpQuotes();
...
//		 AllureListener.setDriver(driver);
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		pq1.setPreQuotesStep1(prop, driver, "TravelPartnerBajaj", i, sheet);
		pq2.setPreQuotesStep2(prop, driver, "TravelPartnerBajaj");
		pq3.setPreQuotesStep3(prop, driver, "TravelPartnerBajaj", i, sheet);
		pq4.setPED(prop, driver, "TravelPartnerBajaj", i, sheet);
		pq5.setPrequotesStep5(prop, driver, "TravelPartnerBajaj", i, sheet);
		quotes.selectPlanTravelPartner("TravelPartnerBajaj", driver, prop);
		nps1.PartnerProposalStep(prop, driver, "TravelPartnerBajaj", i, sheet);
