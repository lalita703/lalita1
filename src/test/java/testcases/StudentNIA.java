...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "StudentNIA", i, sheet);
		npq.selectTripDuration(prop, driver, "StudentNIA");
		npq.selectMemberAndPED(prop, driver, "StudentNIA", i, sheet);
		npq.setMobilePopup(prop, driver, "StudentNIA", i, sheet);
		quotes.selectStudentPlan("StudentNIA", driver, prop);
		nsps.enterStudentProposalDetails(prop, driver, "StudentNIA", i, sheet);
	}
