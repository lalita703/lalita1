...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "Chola", i, sheet);
		npq.selectTripDuration(prop, driver, "Chola");
		npq.selectMemberAndPED(prop, driver, "Chola", i, sheet);
		npq.setMobilePopup(prop, driver, "Chola", i, sheet);
		quotes.selectPlan("Chola", driver, prop);
		Thread.sleep(1000);
		nps1.ProposalStep(prop, driver, "Chola", i, sheet);
