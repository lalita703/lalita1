...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "StudentRSA", i, sheet);
		npq.selectTripDuration(prop, driver, "StudentRSA");
		npq.selectMemberAndPED(prop, driver, "StudentRSA", i, sheet);
		npq.setMobilePopup(prop, driver, "StudentRSA", i, sheet);
		quotes.selectStudentPlan("StudentRSA", driver, prop);
		nsps.enterStudentProposalDetails(prop, driver, "StudentRSA", i, sheet);
	}
