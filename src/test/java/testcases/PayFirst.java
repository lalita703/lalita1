...
public class PayFirst {
	...
	NewProposalPayFirst nps = new NewProposalPayFirst();
...
//	}
	...
	@Test
	public void test(int i, XSSFSheet sheet,String planname) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		System.out.println("Payfirst cases");
		npq.selectCountry(prop, driver, planname, i, sheet);
		npq.selectDurationPayfirst(prop, driver,planname);
		npq.selectMemberAndPED(prop, driver, planname, i, sheet);
		npq.setMobilePopup(prop, driver, planname, i, sheet);
		quotes.selectplanpayfirst(planname, driver, prop);
		nps.ProposalStep(prop, driver, planname, i, sheet);
