...
//		Runtime.getRuntime().exec("taskkill /F /IM chromedriver.exe /T");
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "HDFC", i, sheet);
		npq.selectTripDuration(prop, driver, "HDFC");
		npq.selectMemberAndPED(prop, driver, "HDFC", i, sheet);
		npq.setMobilePopup(prop, driver, "HDFC", i, sheet);
		quotes.selectPlan("HDFC", driver, prop);
		Thread.sleep(1000);
		nps1.ProposalStep(prop, driver, "HDFC", i, sheet);
