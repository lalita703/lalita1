...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "NIC", i, sheet);
		npq.selectTripDuration(prop, driver, "NIC");
		npq.selectMemberAndPED(prop, driver, "NIC", i, sheet);
		npq.setMobilePopup(prop, driver, "NIC", i, sheet);
		quotes.selectPlan("NIC", driver, prop);
		nps1.ProposalStep(prop, driver, "NIC", i, sheet);
