...
public class MultiTripReliance {
...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "MultiReliance", i, sheet);
		npq.selectTripDuration(prop, driver, "MultiReliance");
		npq.selectMemberAndPED(prop, driver, "MultiReliance", i, sheet);
		npq.setMobilePopup(prop, driver, "MultiReliance", i, sheet);
		quotes.selectMultiPlan("MultiReliance", driver, prop);
		Thread.sleep(2000);
		nps1.ProposalStepMulti(prop, driver, "MultiReliance", i, sheet);
