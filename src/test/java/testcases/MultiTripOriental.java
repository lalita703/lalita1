...
public class MultiTripOriental {
...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "MultiOriental", i, sheet);
		npq.selectTripDuration(prop, driver, "MultiOriental");
		npq.selectMemberAndPED(prop, driver, "MultiOriental", i, sheet);
		npq.setMobilePopup(prop, driver, "MultiOriental", i, sheet);
		quotes.selectMultiPlan("MultiOriental", driver, prop);
		Thread.sleep(2000);
		nps1.ProposalStepMulti(prop, driver, "MultiOriental", i, sheet);
	}
