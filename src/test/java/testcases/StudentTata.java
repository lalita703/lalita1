...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "StudentTata", i, sheet);
		npq.selectTripDuration(prop, driver, "StudentTata");
		npq.selectMemberAndPED(prop, driver, "StudentTata", i, sheet);
		npq.setMobilePopup(prop, driver, "StudentTata", i, sheet);
		quotes.selectStudentPlan("StudentTata", driver, prop);
		nsps.enterStudentProposalDetails(prop, driver, "StudentTata", i, sheet);
	}
