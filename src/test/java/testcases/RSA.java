...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "RSA", i, sheet);
		npq.selectTripDuration(prop, driver, "RSA");
		npq.selectMemberAndPED(prop, driver, "RSA", i, sheet);
		npq.setMobilePopup(prop, driver, "RSA", i, sheet);
		quotes.selectPlan("RSA", driver, prop);
		Thread.sleep(1000);
		nps1.ProposalStep(prop, driver, "RSA", i, sheet);
	}
