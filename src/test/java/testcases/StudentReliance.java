...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "StudentReliance", i, sheet);
		npq.selectTripDuration(prop, driver, "StudentReliance");
		npq.selectMemberAndPED(prop, driver, "StudentReliance", i, sheet);
		npq.setMobilePopup(prop, driver, "StudentReliance", i, sheet);
		quotes.selectStudentPlan("StudentReliance", driver, prop);
		nsps.enterStudentProposalDetails(prop, driver, "StudentReliance", i, sheet);
	}
