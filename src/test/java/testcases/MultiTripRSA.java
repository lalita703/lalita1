...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "MultiRSA", i, sheet);
		npq.selectTripDuration(prop, driver, "MultiRSA");
		npq.selectMemberAndPED(prop, driver, "MultiRSA", i, sheet);
		npq.setMobilePopup(prop, driver, "MultiRSA", i, sheet);
		quotes.selectMultiPlan("MultiRSA", driver, prop);
		Thread.sleep(2000);
		nps1.ProposalStepMulti(prop, driver, "MultiRSA", i, sheet);
	}
