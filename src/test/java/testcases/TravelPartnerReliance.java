...
public class TravelPartnerReliance {
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		pq1.setPreQuotesStep1(prop, driver, "TravelPartnerReliance", i, sheet);
		pq2.setPreQuotesStep2(prop, driver, "TravelPartnerReliance");
		pq3.setPreQuotesStep3(prop, driver, "TravelPartnerReliance", i, sheet);
		pq4.setPED(prop, driver, "TravelPartnerReliance", i, sheet);
		pq5.setPrequotesStep5(prop, driver, "TravelPartnerReliance", i, sheet);
		quotes.selectPlanTravelPartner("TravelPartnerReliance", driver, prop);
		nps1.PartnerProposalStep(prop, driver, "TravelPartnerReliance", i, sheet);
	}
