...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "StudentCare", i, sheet);
		npq.selectTripDuration(prop, driver, "StudentCare");
		npq.selectMemberAndPED(prop, driver, "StudentCare", i, sheet);
		npq.setMobilePopup(prop, driver, "StudentCare", i, sheet);
		quotes.selectStudentPlan("StudentCare", driver, prop);
		nsps.enterStudentProposalDetails(prop, driver, "StudentCare", i, sheet);
	}
