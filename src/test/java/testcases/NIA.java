...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "NIA", i, sheet);
		npq.selectTripDuration(prop, driver, "NIA");
		npq.selectMemberAndPED(prop, driver, "NIA", i, sheet);
		npq.setMobilePopup(prop, driver, "NIA", i, sheet);
		quotes.selectPlan("NIA", driver, prop);
		Thread.sleep(1000);
		nps1.ProposalStep(prop, driver, "NIA", i, sheet);
	}
