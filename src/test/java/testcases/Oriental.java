...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "Oriental", i, sheet);
		npq.selectTripDuration(prop, driver, "Oriental");
		npq.selectMemberAndPED(prop, driver, "Oriental", i, sheet);
		npq.setMobilePopup(prop, driver, "Oriental", i, sheet);
		quotes.selectPlan("Oriental", driver, prop);
		Thread.sleep(1000);
		nps1.ProposalStep(prop, driver, "Oriental", i, sheet);
	}
