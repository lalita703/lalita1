...
public class TravelPartnerTataAIG{
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		pq1.setPreQuotesStep1(prop, driver, "TravelPartnerTataAIG", i, sheet);
		pq2.setPreQuotesStep2(prop, driver, "TravelPartnerTataAIG");
		pq3.setPreQuotesStep3(prop, driver, "TravelPartnerTataAIG", i, sheet);
		pq4.setPED(prop, driver, "TravelPartnerTataAIG", i, sheet);
		pq5.setPrequotesStep5(prop, driver, "TravelPartnerTataAIG", i, sheet);
		quotes.selectPlanTravelPartner("TravelPartnerTataAIG", driver, prop);
		nps1.PartnerProposalStep(prop, driver, "TravelPartnerTataAIG", i, sheet);
	}
