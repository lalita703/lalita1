...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "ICICI", i, sheet);
		npq.selectTripDuration(prop, driver, "ICICI");
		npq.selectMemberAndPED(prop, driver, "ICICI", i, sheet);
		npq.setMobilePopup(prop, driver, "ICICI", i, sheet);
		quotes.selectPlan("ICICI", driver, prop);
		Thread.sleep(1000);
		nps1.ProposalStep(prop, driver, "ICICI", i, sheet);
	}
