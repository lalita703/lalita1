...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "StudentBajaj", i, sheet);
		npq.selectTripDuration(prop, driver, "StudentBajaj");
		npq.selectMemberAndPED(prop, driver, "StudentBajaj", i, sheet);
		npq.setMobilePopup(prop, driver, "StudentBajaj", i, sheet);
		quotes.selectStudentPlan("StudentBajaj", driver, prop);
		nsps.enterStudentProposalDetails(prop, driver, "StudentBajaj", i, sheet);
	}
