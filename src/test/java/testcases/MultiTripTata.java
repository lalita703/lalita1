...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "MultiTata", i, sheet);
		npq.selectTripDuration(prop, driver, "MultiTata");
		npq.selectMemberAndPED(prop, driver, "MultiTata", i, sheet);
		npq.setMobilePopup(prop, driver, "MultiTata", i, sheet);
		quotes.selectMultiPlan("MultiTata", driver, prop);
		Thread.sleep(2000);
		nps1.ProposalStepMulti(prop, driver, "MultiTata", i, sheet);
	}
