...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "Reliance", i, sheet);
		npq.selectTripDuration(prop, driver, "Reliance");
		npq.selectMemberAndPED(prop, driver, "Reliance", i, sheet);
		npq.setMobilePopup(prop, driver, "Reliance", i, sheet);
		quotes.selectPlan("Reliance", driver, prop);
		Thread.sleep(1000);
		nps1.ProposalStep(prop, driver, "Reliance", i, sheet);
	}
