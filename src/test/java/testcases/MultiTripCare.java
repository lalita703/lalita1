...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "MultiCare", i, sheet);
		npq.selectTripDuration(prop, driver, "MultiCare");
		npq.selectMemberAndPED(prop, driver, "MultiCare", i, sheet);
		npq.setMobilePopup(prop, driver, "MultiCare", i, sheet);
		quotes.selectMultiPlan("MultiCare", driver, prop);
		Thread.sleep(2000);
		nps1.ProposalStepMulti(prop, driver, "MultiCare", i, sheet);
	}
