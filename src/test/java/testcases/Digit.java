...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "Digit", i, sheet);
		npq.selectTripDuration(prop, driver, "Digit");
		npq.selectMemberAndPED(prop, driver, "Digit", i, sheet);
		npq.setMobilePopup(prop, driver, "Digit", i, sheet);
		quotes.selectPlan("Digit", driver, prop);
		Thread.sleep(1000);
		nps1.ProposalStep(prop, driver, "Digit", i, sheet);
