...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "Bajaj", i, sheet);
		npq.selectTripDuration(prop, driver, "Bajaj");
		npq.selectMemberAndPED(prop, driver, "Bajaj", i, sheet);
		npq.setMobilePopup(prop, driver, "Bajaj", i, sheet);
		quotes.selectPlan("Bajaj", driver, prop);
		nps1.ProposalStep(prop, driver, "Bajaj", i, sheet);
