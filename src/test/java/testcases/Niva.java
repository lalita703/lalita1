...
//	}
	...
	public void test(int i, XSSFSheet sheet) throws Exception {
		Properties prop = resfun.readPropertiesFile("config.properties");
		npq.selectCountry(prop, driver, "Niva", i, sheet);
		npq.selectTripDuration(prop, driver, "Niva");
		npq.selectMemberAndPED(prop, driver, "Niva", i, sheet);
		npq.setMobilePopup(prop, driver, "Niva", i, sheet);
		quotes.selectPlan("Niva", driver, prop);
		Thread.sleep(1000);
		nps1.ProposalStep(prop, driver, "Niva", i, sheet);
	}
